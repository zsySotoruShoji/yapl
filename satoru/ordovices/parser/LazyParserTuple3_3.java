...
public class LazyParserTuple3_3<A1,A2,A3> implements Parser<Tuple3<A1,A2,A3>>{

    private final Parser<A1> p1;
    private final Parser<A2> p2;
    private final Supplier<Parser<A3>> p3;

    public LazyParserTuple3_3(
            Parser<A1> p1, Parser<A2> p2, Supplier<Parser<A3>> p3){
        this.p1 = p1;
        this.p2 = p2;
        this.p3 = p3;
    }

    public static <A1,A2,A3> LazyParserTuple3_3<A1,A2,A3> t(
            Parser<A1> p1,
            Parser<A2> p2,
            Supplier<Parser<A3>> p3){
        return new LazyParserTuple3_3<>(p1, p2, p3);
    }
